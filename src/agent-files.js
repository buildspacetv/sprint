...
- **Frontier models** — NVIDIA Nemotron 3 Super on Nebius Token Factory over an
  OpenAI-compatible API, for the reasoning layer or for routing a coding agent through
  kimirelay.
